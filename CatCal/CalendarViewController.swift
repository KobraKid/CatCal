 ...
 */
class CalendarViewController: UICollectionViewController, GIDSignInDelegate, GIDSignInUIDelegate {
    ...
    override func viewDidLoad() {
        ...
        NotificationCenter.default.addObserver(self, selector: #selector(CalendarViewController.refreshView), name: NSNotification.Name(rawValue: eventsRequireRefreshKey), object: nil)
        ...
        let swipeGesture = UISwipeGestureRecognizer(target: self, action: #selector(CalendarViewController.swipeLeft))
    ...
    func sign(_ signIn: GIDSignIn!, didSignInFor user: GIDGoogleUser!, withError error: Error!) {
        if let error = error {
            ...
            CalendarViewController.generalErrorTitle = "Authentication Error"
            ...
            CalendarViewController.service.authorizer = nil
        } else {
            signInButton.isHidden = true
            logo.isHidden = true
            refreshButton.isHidden = false
            newEventButton.isHidden = false
            CalendarViewController.service.authorizer = user.authentication.fetcherAuthorizer()
    ...
    @IBAction func newEventAction(_ sender: Any) {
        ...
        if !CalendarViewController.newEventPopupIsVisible {
            ...
            CalendarViewController.newEventPopupIsVisible = true
        }
    }
    ...
    @objc func refreshView() {
        ...
        log.verbose(CalendarViewController.events)
    ...
    @objc func showAlert() {
        let alert = UIAlertController(
            title: CalendarViewController.generalErrorTitle,
            message: CalendarViewController.generalErrorMessage,
...
extension CalendarViewController: UICollectionViewDelegateFlowLayout {
    ...
    override func collectionView(_ collectionView: UICollectionView, numberOfItemsInSection section: Int) -> Int {
        return CalendarViewController.events.count
    }
    ...
    override func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell{
        ...
        cell.textLabel.text = CalendarViewController.events[indexPath.item].description
    ...
    func collectionView(_ collectionView: UICollectionView, layout collectionViewLayout: UICollectionViewLayout, sizeForItemAt indexPath:
        IndexPath) -> CGSize {
        return CGSize(width: view.frame.width, height: (view.frame.height - CalendarViewController.navHeight) / CGFloat(cellCount))
    }
    ...
    override func collectionView(_ collectionView: UICollectionView, didSelectItemAt indexPath: IndexPath) {
        let id = CalendarViewController.events[indexPath.item].id
